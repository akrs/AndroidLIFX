...
public enum PacketType {
	DISCOVER_REQUEST,DISCOVER_RESPONSE,ON_OFF_REQUEST,ON_OFF_RESPONSE,GET_LABEL_REQUEST,SET_LABEL_REQUEST,LABEL_RESPONSE,GET_STATUS_REQUEST,SET_STATE_REQUEST,STATUS_RESPONSE,UNKNOWN;
